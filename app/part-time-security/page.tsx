...
export const metadata: Metadata = {
  title: 'Part-Time Security Leadership UK | Hire Part-Time Security Executives',
  description: 'Hire part-time security leaders for your business. Part-time CISOs, Security Directors, and InfoSec Managers. Expert security leadership without full-time cost.',
  keywords: 'part-time security, part-time security director, part-time security executive, part-time ciso, hire security leader',
  alternates: { canonical: 'https://part-time.quest/part-time-security' },
}

export default function PartTimeSecurityPage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 w-full py-20">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="max-w-4xl">
              ...
              <h1 className="text-5xl md:text-7xl font-black text-white mb-6 leading-[0.9]">Part-Time<br /><span className="text-red-400">Security</span></h1>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link href="/part-time-ciso-services" className="px-8 py-4 border-2 border-white text-white font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-colors">Part-Time CISO Services</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <h2 className="text-3xl font-black text-gray-900 mb-6">Part-Time Security Leadership</h2>
          <p className="text-xl text-gray-600 leading-relaxed mb-6">Cyber security is a board-level concern, but not every company can afford a full-time CISO. Part-Time security leaders provide the expertise to build security programmes, achieve compliance, and manage risk—on a part-time basis.</p>
          <div className="grid md:grid-cols-3 gap-6 mt-10">
            {[
              { title: 'Part-Time CISO', description: 'C-level security leadership for strategy and governance.', link: '/part-time-ciso-services' },
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <h2 className="text-3xl font-black text-gray-900 mb-8">What Part-Time Security Leaders Do</h2>
      ...
      <section id="contact" className="py-20 bg-black text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 mb-10">Tell us about your security challenges and we'll match you with the right part-time security executive.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/part-time-ciso-services" className="px-10 py-5 border-2 border-white text-white font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-colors">Learn About Part-Time CISOs</Link>
          </div>
        </div>
      </section>
    </div>
